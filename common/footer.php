  <div id="exhibit-sections-footer">
    <p style="text-align:right;">timeline of events</p>
  </div>
  <div id="info-footer">
    <div id="bd" role="main">
      <div>
        ...
        To move the timeline: use the mouse scroll wheel or the arrow keys, or grab and drag the timeline.
      </div>
    </div>
  </div>

</div><!-- end id="wrap" -->
<p class="footer11px">Columbia University Archives / Rare Book &amp; Manuscript Library / Butler Library, 6th Fl. East / 535 West 114th St. / New York, NY 10027 / (212) 854-3786 / <a href="mailto:uarchives@columbia.edu">uarchives@columia.edu</a></p>
